...
void scalability_analysis(const vector<size_t>& sizes, int num_threads, int runs = 3) {
    ...
    cout << setw(8) << "Size" << setw(15) << "Serial(s)" << setw(15) << "Parallel(s)" << setw(12) << "Speedup" << setw(15) << "Efficiency\n";
...
void thread_scaling_analysis(size_t n, const vector<int>& threads_to_test, int runs = 3) {
    ...
    cout << "\n\n";
    cout << setw(8) << "Threads" << setw(15) << "Serial(s)" << setw(15) << "Parallel(s)" << setw(12) << "Speedup" << setw(15) << "Efficiency\n";
    cout << string(70, '-') << "\n";
